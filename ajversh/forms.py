...
class CreateBuildForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['hand'].queryset =Item.objects.filter(set_part='Broń jednoręczna') or Item.objects.filter(set_part='Broń dwuręczna')
        self.fields['second_hand'].queryset = Item.objects.filter(set_part='Druga broń')
        ...
        self.fields["second_hand"].widget.attrs.update({"class": "select-build"})
